 ...
 * @property {boolean} [disableListeners=false] This value determines if event listeners should be attached by the library to control the menu (vs calling the auxillery methods).
...
export default class RadialMenu {
	...
	constructor({fontFamily, fontSize, innerCircle, outerCircle,
							...
							textShadowOffsetX, textShadowOffsetY, buttonGap, buttons, hoverAction, disableListeners,
